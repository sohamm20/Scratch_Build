...
function CatSprite_CatSprite(_ref) {
  let {
    some_w,
    some_h
  } = _ref;
  return /*#__PURE__*/react.createElement((cjs_default()), null, /*#__PURE__*/react.createElement("svg", {
...
;// CONCATENATED MODULE: ./src/components/image_.png
/* harmony default export */ const image_ = (__webpack_require__.p + "images/image_.png");
...
const MidArea = () => {
  ...
  const [meas, setMeas] = (0,react.useState)({
    some_w: "95.17898101806641",
    some_h: "100.04156036376953"
  });
  const [rotation, setRotation] = (0,react.useState)(0);
  const [sayHello, setSayHello] = (0,react.useState)(false);
  const switchHello = () => {
    setSayHello(true);
    setTimeout(() => {
      setSayHello(false);
  ...
  const make10x = () => {
    // Convert strings to integers using parseInt, multiply by 10, and convert back to strings
    let d_w = (parseInt(meas.some_w, 10) * 2).toString();
    let d_h = (parseInt(meas.some_h, 10) * 2).toString();

    // Update the meas state with the new string values
    setMeas({
      some_w: d_w,
      some_h: d_h
    });
    ...
    actions.forEach(action => {
      switch (action.type) {
        ...
        case "Random Position":
          newPosition.y += Math.random() * 200;
          newPosition.x += Math.random() * 200;
          break;
        case "Say Hello!":
          alert('Hello!');
          break;
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("div", {
    ...
    src: image_,
    alt: "cat",
    className: `ml-10 h-20 w-20 ${sayHello ? '' : 'hidden'}`
  }), /*#__PURE__*/react.createElement(CatSprite_CatSprite, {
    some_w: meas.some_w,
    some_h: meas.some_h
  })))));
};
